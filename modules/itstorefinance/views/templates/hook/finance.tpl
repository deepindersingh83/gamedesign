...
<div class="itstore-finance">
  ...
  <span class="itstore-finance__text">
    {l s='or from' mod='itstorefinance'}
    <strong class="itstore-finance__amount">{$itstore_fin_monthly}</strong>
    /{l s='month' mod='itstorefinance'}
    {if $itstore_fin_apr > 0}
      <span class="itstore-finance__terms">({$itstore_fin_months|intval} {l s='months' mod='itstorefinance'}, {$itstore_fin_apr}% {l s='APR' mod='itstorefinance'})</span>
    {else}
      <span class="itstore-finance__terms">({$itstore_fin_months|intval} {l s='months interest-free' mod='itstorefinance'})</span>
    {/if}
    {if $itstore_fin_url}
