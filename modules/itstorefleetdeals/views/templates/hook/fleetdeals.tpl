  ...
  <div class="container">
    <div class="itstore-fd__grid">
      <div class="itstore-fd__fleet">
        ...
        <a class="itstore-fd__quote-btn" href="{$fd_quote_url|escape:'html':'UTF-8'}">{l s='Request Quote' mod='itstorefleetdeals'}</a>
      </div>
      <div class="itstore-fd__clearance">
        ...
        <a class="itstore-fd__cl-link" href="{$fd_cl_link|escape:'html':'UTF-8'}">{l s='Shop Deals' mod='itstorefleetdeals'} &rarr;</a>
      </div>
    </div>
  </div>
</section>
