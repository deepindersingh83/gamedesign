...
{block name='page_title'}{l s='Track your order' d='Modules.Itstoreordertrack.Shop'}{/block}
{block name='page_content'}
  <div class="itstore-track">
    <form class="itstore-track__form" method="post" action="{$track_action|escape:'html':'UTF-8'}">
      ...
      <input type="text" name="reference" required placeholder="{l s='Order reference (e.g. ABCDEFGHI)' d='Modules.Itstoreordertrack.Shop'}">
      <input type="email" name="email" required placeholder="{l s='Email on the order' d='Modules.Itstoreordertrack.Shop'}">
      <button type="submit" class="btn btn-primary">{l s='Track order' d='Modules.Itstoreordertrack.Shop'}</button>
    </form>
